...
LABEL description="Handover Manager xApp"
LABEL version="1.0.0"
...
# Copy xApp SDK and Handover xApp code
COPY 03-Implementation/ric-platform/xapp-sdk/ /app/xapp-sdk/
COPY 03-Implementation/ric-platform/xapps/handover_manager_xapp.py /app/xapps/
...
# Run Handover xApp
CMD ["python", "-m", "xapps.handover_manager_xapp"]
